    ...
    <nav className="fixed top-0 left-0 w-full bg-white bg-opacity-80 backdrop-blur-lg shadow-md z-50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:block space-x-4">
          <Link
            href="/tools"
            className="bg-[#F78B55] text-white px-5 py-2 rounded hover:bg-gray-300 transition-all duration-300"
          >
            Tools
          </Link>
          <button
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <Link
              href="/tools"
              className="bg-[#F78B55] text-white px-6 py-2 rounded-full hover:bg-green-700 transition-all duration-300"
              onClick={toggleMenu}
            >
              Tools
            </Link>
